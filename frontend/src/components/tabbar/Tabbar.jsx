...
import { FaTachometerAlt, FaUniversity, FaUserGraduate, FaBook, FaGlobe, FaChalkboardTeacher } from "react-icons/fa";
...
const Tabbar = ({ setView }) => {
  ...
  const changeLanguage = (lng) => {
    ...
    setActiveDropdown(false); // Tắt dropdown ngay sau khi chọn
